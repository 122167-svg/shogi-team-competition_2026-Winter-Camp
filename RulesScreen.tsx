  ...
  const rules = [
    {
      title: "大会概要・基本ルール",
      items: [
        "1チーム4〜5名構成（チーム①・チーム②は5名＋補欠1名）、4チームによる全3回戦の総当たり戦です。",
    ...
    {
      title: "チーム①・チーム②の補欠運用（対局毎に変動可）",
      items: [
        "チーム① と チーム② は、登録メンバー5名のうち4名がスロットA〜Dに入り、1名を補欠として指定します。",
        "補欠は対局毎に自由に変更可能（スロット4名のうち誰かをベンチに下げることも可能）。",
        "スロット4名はユニーク（重複不可）。補欠はスロットの4名と異なる選手を指名してください。",
        "チーム③ と チーム④ は4名構成のため補欠はいません。",

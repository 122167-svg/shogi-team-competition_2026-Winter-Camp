...
const RoundPreview: React.FC<Props> = ({ round, onNext }) => {
  return (
    <div className="text-center space-y-12 animate-fadeIn max-w-6xl mx-auto">
              ...
              <div className="flex items-center justify-between gap-3">
                ...
                <div className="flex-1 space-y-3">
                  ...
                  <div className="flex flex-col gap-1.5">
                    {t1?.players.map(p => (
                      <div key={p} className="text-[10px] font-bold bg-stone-800 text-stone-300 py-1.5 px-2 rounded border border-stone-700 shadow-inner">
                        {p}
                      </div>
                    ))}
                  </div>
                ...
                <div className="shrink-0 z-10">
                  <div className="vs-badge text-base scale-110">VS</div>
                </div>
